 ...
 */
export declare type PreloadResult<T extends Piece> = Awaited<Constructor<T> & Record<PropertyKey, unknown>>;
/**
 * Represents the return data from [[ILoaderStrategy.preload]]
 */
export declare type AsyncPreloadResult<T extends Piece> = Promise<Constructor<T> & Record<PropertyKey, unknown>>;
/**
...
//# sourceMappingURL=ILoaderStrategy.d.ts.map